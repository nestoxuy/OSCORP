...
|**Left side**|![Left side]( )|
|**Front Train**|![Front Train]( )|
|**rear train**|![rear_train]( ) |
...
|------|-----------|------------------|------|
|**Button and Resistor** |Components indicating program execution: Program activation button, and 200Ω resistor preventing LED burnout|At first we used it as an indicator that the program was running but there came a time when it stopped working|![LED_Diode,_Button_and_Resistor](https://github.com/nestoxuy/OSCORP/blob/main/other/Fotos/LED_button_diode_and_resistor.jpg "LButton_and_resistor")|
